...
text="<@${slack_user:-$GITHUB_ACTOR}> use \`$ssh_url\` to access the env for <https://github.com/$GITHUB_REPOSITORY/actions/runs/$GITHUB_RUN_ID|this run> of <https://github.com/$GITHUB_REPOSITORY/commit/$GITHUB_SHA|this $GITHUB_REPOSITORY commit>$commit_msg"
